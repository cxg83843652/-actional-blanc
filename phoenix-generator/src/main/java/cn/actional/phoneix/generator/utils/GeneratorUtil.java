package cn.actional.phoneix.generator.utils;

import cn.actional.phoneix.common.utils.BaseException;
import cn.actional.phoneix.common.utils.DateUtils;
import cn.actional.phoneix.generator.entity.ColumnEntity;
import cn.actional.phoneix.generator.entity.TableEntity;
...
public class GeneratorUtil {
    ...
    public static void generatorCode(Map<String, String> tableInfo,
        ...
        map.put("comments", tableEntity.getColumns());
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/codeTemplates/Dao.java.vm");
        templates.add("templates/codeTemplates/Dao.xml.vm");
